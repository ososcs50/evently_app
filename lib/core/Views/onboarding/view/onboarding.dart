...
import 'package:evently_app/core/Views/onboarding/manger/onboard_pro.dart';
import 'package:evently_app/core/Views/onboarding/widget/page_body.dart';
import 'package:evently_app/core/Views/onboarding/widget/pageindicator.dart';
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            pro.current == pages.length - 1
                                ? TextButton(
                                    onPressed: () =>
                                        context.goAndRemove(LoginScreen()),
                                    child: Text(
                                      'Get Started',
